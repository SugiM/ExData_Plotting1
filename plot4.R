...
par(mfrow=c(2,2), mar=c(4,4,2,2),ps = 15, cex = 0.70,cex.main=0.70)
...
legend("topright",col=c("black", "red", "blue"), lty=1, bty="n",cex=0.65,legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"))
